...
class MessageLocationDisplayWidget extends StatelessWidget {
  final MessageModel? message;
  final bool isReceiver;
  const MessageLocationDisplayWidget({Key? key,@required this.message,this.isReceiver=false}) : super(key: key);
